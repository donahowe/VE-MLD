...
class ViT(nn.Module):
    def __init__(self, *, image_size, patch_size=16, num_classes=6, dim=768, depth=12, heads=12, mlp_dim_ratio=4, pool = 'cls', channels = 3, dim_head = 64, dropout = 0., emb_dropout = 0.):
        super().__init__()

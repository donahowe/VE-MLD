...
parser.add_argument('--data', type=str, default='/data2/chengjunhao/data/coco2014')
parser.add_argument('--lr', default=1e-4, type=float)
parser.add_argument('--model-name', default='vit')
parser.add_argument('--model-path', default='/data2/chengjunhao/ML_Decoder/models1/model-highest.ckpt', type=str)
...
parser.add_argument('--epoch', default=400, type=int, help='number of training epoches')
...
def main():
    ...
    # LEAF Data loading
        data_path_val =  os.path.join(args.data, 'train/images') 
        instances_path_val = os.path.join(args.data, 'val/label.json') 
        data_path_train = os.path.join(args.data, 'train/images') 
        instances_path_train = os.path.join(args.data, 'train/label.json')  
    ...
    for epoch in range(Epochs):
        ...
        try:
            torch.save(model.state_dict(), os.path.join(
                'models1/', 'model-{}-{}.ckpt'.format(epoch + 1, i + 1)))
        except:
            pass

...
parser.add_argument('--model-path', type=str, default='/data2/chengjunhao/ML_Decoder/models/model-highest.ckpt')
parser.add_argument('--pic-path', type=str, default='/data2/chengjunhao/data/LEAF/test/images/f4bcdb58fdf10080.jpg')
...
def main():
    ...
    classes_list = np.array(list(['healthy','rust','scab','frog_eye_leaf_spot','powdery_mildew','complex']))
    print('done\n')

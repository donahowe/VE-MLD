...
from src_files.helper_functions.helper_functions import mAP, CocoDetection, AverageMeter, LEAFDetection
...
def main():
    ...
    validate_multi(val_loader, model, args, len(val_dataset))


def validate_multi(val_loader, model, args, num):
    ...
    #Calcuate Acc
    Acc=0
    for b1,b2 in zip(targets,preds1):
